...
(function (window, document, $) {
    ...
    $.app.menu = {
        ...
        changeMenu: function (screen) {
            ...
            if (screen == "sm" || screen == "xs") {
                ...
                menuNavigation
                    .removeClass()
                    .addClass("navigation navigation-main");
    ...
    $.app.nav = {
            ...
            $(".navigation-main")
                .on("mouseenter.app.menu", "li", function () {
                    ...
                    if (
                        ...
                        var menu_header_height = $(".navbar-header").length
                ...
                if (
                    ...
                    setTimeout(function () {
                        if (
                            ...
                            $(".main-menu, .navbar-header").removeClass(
                                "expanded"
                            );
                            if ($body.hasClass("menu-collapsed")) {
        ...
        adjustSubmenu: function ($menuItem) {
            ...
            scroll_theme = $(".main-menu").hasClass("menu-dark")
                ? "light"
                : "dark";

            topPos =
                menuHeaderHeight + menutop + $menuItem.height() + borderWidth;
