...
$(window).on("load", function () {
    var gradientChart = new Chartist.Pie(
        "#donut-gradient-chart",
        {
            series: [100],
            labels: ["iOS"],
        },
    ...
    var gradientChart1 = new Chartist.Pie(
        "#donut-gradient-chart1",
        {
            series: [100],
            labels: ["iOS"],
        },
    ...
    var gradientChart2 = new Chartist.Pie(
        "#donut-gradient-chart2",
        {
            series: [100],
            labels: ["iOS"],
        },
    ...
    var gradientChart3 = new Chartist.Pie(
        "#donut-gradient-chart3",
        {
            series: [100],
            labels: ["iOS"],
        },
    ...
    var gradientChart4 = new Chartist.Pie(
        "#donut-gradient-chart4",
        {
            series: [100],
            labels: ["iOS"],
        },
    ...
    var gradientChart5 = new Chartist.Pie(
        "#donut-gradient-chart5",
        {
            series: [100],
            labels: ["iOS"],
        },
