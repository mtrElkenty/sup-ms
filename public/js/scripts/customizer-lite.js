...
(function (window, document, $) {
    ...
    if (menu_type === "vertical-overlay-menu") {
        ...
        if (
            menu_type === "vertical-compact-menu" ||
            menu_type === "vertical-overlay-menu"
        ) {
            $("#boxed-layout")
                .parent(".custom-checkbox")
                .attr("style", "display: none !important");
        }
        $(".color-options .nav-semi-light")
            .parent(".nav-item")
            .attr("style", "display: none !important");
        $(".color-options .nav-semi-dark")
            .parent(".nav-item")
            .attr("style", "display: none !important");
    }
    ...
    $("#fixed-layout").on("click", function () {
        ...
        if ($(this).prop("checked") === true) {
            ...
            if (
                !horz_header_navbar.hasClass("navbar-fixed") &&
                horz_layout === true
            ) {
    ...
    function setSwitchery(switchElement, checkedBool) {
        if (checkedBool && !switchElement.is(":checked")) {
            // switch on if not on
    ...
    $("#sidebar-color-option").on("change", function () {
        if (menuBackground.checked === true) {
            $(".main-menu")
                .removeClass("menu-dark menu-light")
                .addClass("menu-dark");
        } else {
            $(".main-menu")
                .removeClass("menu-dark menu-light")
    ...
    $(document).ready(function () {
        ...
        $("#twitter").sharrre({
            ...
            enableCounter: false,
            buttons: { twitter: { via: "MtrElkenty" } },
