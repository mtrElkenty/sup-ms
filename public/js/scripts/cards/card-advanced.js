...
(function (window, document, $) {
    ...
    var ProjectStatsBar = new Chartist.Bar(
    ...
    var ProjectStatsLine = new Chartist.Line(
        "#progress-stats-line-chart",
        {
    ...
    var ProjectStatsBar1 = new Chartist.Bar(
    ...
    var ProjectStatsLine1 = new Chartist.Line(
        "#progress-stats-line-chart1",
        {
    ...
    var ProjectStatsBar2 = new Chartist.Bar(
    ...
    var ProjectStatsLine2 = new Chartist.Line(
        "#progress-stats-line-chart2",
        {
    ...
    var statisticsDonutChart = new Chartist.Pie(
        ...
        if (data.type === "label") {
            if (data.index === 0) {
                data.element.attr({
                    ...
                    dy:
                        (data.element.root().height() +
                            data.element.height() / 4) /
                        2,
                    class: "ct-label",
                    "font-family": "feather",
                });
    ...
    var newCustomers = new Chartist.Pie(
        "#new-customers",
        {
            series: [100],
            labels: ["iOS"],
    ...
    var newProjects = new Chartist.Pie(
        "#new-projects",
        {
            series: [100],
            labels: ["iOS"],
    ...
    var tasksCompleted = new Chartist.Pie(
        "#tasks-completed",
        {
            series: [100],
            labels: ["iOS"],
