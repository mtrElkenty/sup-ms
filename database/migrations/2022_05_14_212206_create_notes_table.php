...
class CreateNotesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('notes', function (Blueprint $table) {
            ...
            $table->integer('annees_scolairesid_annee_scolaire');
            
            $table->foreign('matieres_id_matiere', 'FKnotes299100')->references('id_matiere')->on('matieres');
            $table->foreign('annees_scolairesid_annee_scolaire', 'FKnotes33897')->references('id_annee_scolaire')->on('annees_scolaires');
