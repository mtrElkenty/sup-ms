                                    ...
                                    @else
                                        ...
                                        <tbody>
                                            @foreach($cycles as $cycle)
                                                <tr>
                                                    <th id="{{ $cycle->id_cycle . '-libelle_cycle' }}" scope="row">{{$cycle->libelle_cycle}}</th>
                                                    <td id="{{ $cycle->id_cycle . '-nombre_annees' }}">{{$cycle->nombre_annees}}</td>
                                ...
                                <div class="table-responsive">
                                    ...
                                    @else
                                        ...
                                        @foreach($niveaux as $niveau)
                                            <tr>
                                                <td id="{{$niveau->id_niveau}}-libelle_niveau">{{$niveau->libelle_niveau}}</td>
                                                <td id="{{$niveau->id_niveau}}-cycles_id_cycle">{{$niveau->cycles_id_cycle}}</td>
                                                <td class="table-actions">
                                                    <button type="button" class="edit"
                                                            data-toggle="modal"
                            ...
                            <div class="table-responsive">
                                ...
                                @else
                                    ...
                                    @foreach($filieres as $filiere)
                                        <tr>
                                            <th id="{{$filiere->id_filiere}}-code_filiere" scope="row">{{$filiere->code_filiere}}</th>
                                            <td id="{{$filiere->id_filiere}}-libelle_filiere">{{$filiere->libelle_filiere}}</td>
                                            <td id="{{$filiere->id_filiere}}-cycles_id_cycle">{{$filiere->cycles_id_cycle}}</td>
                                            <td class="table-actions">
                                                <button type="button" class="edit"
                                                        data-toggle="modal"
