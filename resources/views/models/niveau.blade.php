...
<div
    ...
    tabindex="-1"
    role="dialog"
    aria-labelledby="ajouterNiveauLabel"
    aria-hidden="true">
    <div
        class="modal-dialog"
        role="document">
...
<div
    style="z-index: 10000"
    class="modal fade" id="modifierNiveau"
    tabindex="-1"
    role="dialog"
    aria-labelledby="modifierNiveauLabel"
    aria-hidden="true">
    <div
        class="modal-dialog"
        role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5
                    class="modal-title"
                    id="modifierNiveauModifierLabel">
                    Modifier Niveau
                </h5>
                <button
                    type="button"
...
<div
    ...
    tabindex="-1"
    role="dialog"
    aria-labelledby="supprimerNiveauLabel"
    aria-hidden="true">
    <div
        class="modal-dialog"
        role="document">
