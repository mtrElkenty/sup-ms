                                            ...
                                            @foreach ($professeurs as $professeur)
                                                <tr>
                                                    ...
                                                    <td id="{{ $professeur->id_employe . '-telephones' }}">
                                                        {{ $professeur->telephone_1 . ' ' . $professeur->telephone_2 }}
                                                    </td>
                                                    <td id="{{ $professeur->id_employe . '-email' }}">
                                                        {{ $professeur->email }}</td>
                                                    <td id="{{ $professeur->id_employe . '-adress' }}">
                                                        {{ $professeur->pays . ' - ' . $professeur->ville . ', ' . $professeur->adress }}
                                                    </td>
                                                    <td style="display: flex; border: none">
                                                        <a href="/professeurs/modifier/{{ $professeur->id_employe }}"
                                                            class="btn btn-primary px-1 mr-1">
