            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <a href="/{{ isset($is_prof_page) ? 'professeurs' : 'employes' }}/ajouter"
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                @if (sizeof($employes) == 0)
                                    <h3>Commencez par <a
                                            href="/{{ isset($is_prof_page) ? 'professeurs' : 'employes' }}/ajouter">ajouter</a>
                                        des employes</h3>
                                @else
                                    <table class="table">
                                        <thead>
                                            ...
                                            @foreach ($employes as $employe)
                                                <tr>
                                                    ...
                                                    <td id="{{ $employe->id_employe . '-adress' }}">
                                                        {{ $employe->pays . ' - ' . $employe->ville . ', ' . $employe->adress }}
                                                    </td>
                                                    <td id="{{ $employe->id_employe . '-fonction' }}">
                                                        {{ $employe->fonction->fonction }}</td>
                                                    <td class="table-actions">
                                                        <a href="/{{ isset($is_prof_page) ? 'professeurs' : 'employes' }}/modifier/{{ $employe->id_employe }}"
                                                            class="edit">
