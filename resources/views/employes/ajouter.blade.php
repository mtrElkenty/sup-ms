    ...
    <div class="content-header row">
        <div
            ...
            <h3 class="content-header-title">
                Ajouter {{ isset($is_prof_page) ? 'Professeurs' : 'Employes' }}
            </h3>
        </div>
    </div>
                        ...
                        <div class="card-body">
                            <form action="/employes/" method="POST" id="ajouterEmployeForm">
                                ...
                                @error('NNI')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <input type="number" name="NNI" value="{{ old('NNI') }}" placeholder="NNI"
                                    class="form-control mb-1 @error('NNI') is-invalid @enderror">

                                @error('telephone_1')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <input type="number" name="telephone_1" value="{{ old('telephone_1') }}"
                                ...
                                @error('telephone_2')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <input type="number" name="telephone_2" value="{{ old('telephone_2') }}"
                                ...
                                @error('adress')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <input type="text" name="adress" value="{{ old('adress') }}" placeholder="Adress"
                                    class="form-control mb-1 @error('adress') is-invalid @enderror">

                                @error('ville')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <input type="text" name="ville" value="{{ old('ville') }}" placeholder="Ville"
                                    class="form-control mb-1 @error('ville') is-invalid @enderror">

                                @error('pays')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <input type="text" name="pays" value="{{ old('pays') }}" placeholder="Pays"
                                ...
                                <div id="date-picker-example"
                                    ...
                                    <input name="date_naissance" type="date"
                                        value="{{ date('Y-m-d', strtotime(old('date_naissance'))) }}"
